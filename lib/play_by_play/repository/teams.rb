  ...
  module RepositoryModule
    class Teams < Base
      ...
      def team(team)
        ...
        if games.positive?
          add_opposition_stats(team, games)
        end
      ...
      def add_stats(team, games)
        ...
        team[:points] = total_points(plays) / games.to_f
      end
      # rubocop:enable Metrics/AbcSize

      def add_opposition_stats(team, games)
        ...
        team[:opponent_points] = total_points(plays) / games.to_f
      end
